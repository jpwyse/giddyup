      ...
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1, background: '#2D3436' }}>
        <Toolbar sx={{ mt: 0.5, pr: 24 }}>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            ...
            <Button onClick={() => navigate("../site/contact")} sx={{ display: 'block', font: '22px Aldrich', fontWeight: 'bold', color: urlPath === "/contact" ? '#A8E4A0' : '#8884D8', textShadow: '2px 3px 4px rgba(245,245,245,0.5)', textDecoration: urlPath === "/contact" ? 'underline' : null, textDecorationThickness: urlPath === "/contact" ? '4px' : null, "&:hover": { color: '#A8E4A0', transform: 'scale(1.03)', textDecoration: 'underline', textDecorationThickness: '4px'} }}>
              Contact
            </Button>
            {!dashRoute && !isAuth ?
              <React.Fragment>
                <Button hidden={dashRoute} variant='outlined' onClick={() => navigate("../site/login")} sx={{ display: 'block', font: '20px Aldrich', fontWeight: 'bold', color: urlPath === "/login" ? '#A8E4A0' : '#8884D8', textShadow: '2px 3px 4px rgba(245,245,245,0.5)', border: '3px solid', ml: 5, mt: -0.5, pt: 1, "&:hover": { color: '#A8E4A0', transform: 'scale(1.03)', border: '3px solid' } }}>
                  Login
                </Button>
                <Button variant='outlined' onClick={() => navigate("../site/signup")} sx={{ display: 'block', font: '20px Aldrich', fontWeight: 'bold', color: urlPath === "/signup" ? '#A8E4A0' : '#8884D8', textShadow: '2px 3px 4px rgba(245,245,245,0.5)', border: '3px solid', ml: 1, mt: -0.5, pt: 1, "&:hover": { color: '#A8E4A0', transform: 'scale(1.03)', border: '3px solid' } }}>
                  Signup
                </Button>
              </React.Fragment>
            : null }
          </Box>
          <Box sx={{ display: { xs: 'flex', md: 'none' }, ml: 12 }}>
